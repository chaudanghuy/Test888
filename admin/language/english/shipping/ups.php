...
$_['entry_dimension']			   = 'Dimensions (L x W x H):<br /><span class="help">Individual items are not rated as their own package. The cart is rated as a single package and these are the dimensions of the box all the cart items would ship in. Default 10x10x10</span>';
