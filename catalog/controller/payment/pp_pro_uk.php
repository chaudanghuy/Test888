...
class ControllerPaymentPPProUK extends Controller {
	...
	public function send() {
		...
		if (curl_error($curl)) {
			...
			$this->log->write('PP_Pro DoDirectPayment CURL ERROR: ' . curl_errno($curl) . '::' . curl_error($curl));	
			...
			$this->log->write('PP_Pro_UK DoDirectPayment CURL ERROR: Empty Gateway Response');
		}
